...
SYSTEM = (
    ...
    "你的目标受众是 25-55 岁的宝妈，她们最关心：搞钱底气、带娃间隙成长、柴米油盐的精打细算、女性独立、自我价值。"
    "你的服务对象是一位明确的宝妈人设："
    ...
    "文案要感人、有力量、通透、利他，像一位真实、有阅历的宝妈在跟 25-55 岁的姐妹掏心掏肺聊天，"
...
def build_user_prompt(hot, sources=None):
    ...
    if sources:
        KEYS = [
            ...
            ("宝妈情感共鸣", "宝妈情感共鸣（你给的真实素材：带娃搞钱/自我成长/不内耗）"),
        ]
        ...
        for key, label in KEYS:
            show_n = 6 if key == "宝妈情感共鸣" else 4
            block += fmt(label, sources.get(key), show_n)
        if block:
            src_block = (
...
{{
  ...
  "image_copywriting": [   // 10 条：用于图片上的图文文案（重点！）
    {{
      ...
      "body_long": "延展性正文（长版）10 句：继续展开，紧扣 25-55 岁宝妈切身相关的话题——带娃搞钱、女性成长、自我底气、柴米油盐的精打细算、做自媒体的真实挣扎与复利。语气像姐妹掏心掏肺，利他、通透、能给方法",
      "body_short": "延展性正文（短版）5-6 句：长版的精简版，同样吸引 25-55 岁宝妈，保留钩子感与通透劲",
...
写作要求（重点）：
1. 人设与目标受众贯穿：她是想赚钱、努力活着、有正能量的宝妈；受众是 25-55 岁宝妈，最关心搞钱底气、带娃成长、柴米油盐、女性独立。文案真实扎实，不浮夸。
...
6. reflection 1-2 句；body_long 必须 10 句；body_short 必须 5-6 句；三者都紧扣 25-55 岁宝妈、关联自媒体搞钱与柴米油盐。注意：title+quote+reflection 会合并成『图上正文』放到图片上（再次强调：quote/reflection 的每一句都应是独立完整的 12-16 字整句，不要靠逗号把小分句拼成长句），『图上正文』放到图片上，要求写成一段连贯正文——总句数 ≤10 句、每句 12-16 字、句子之间自然衔接（像一口气写下来），标题就是第一句钩子。
7. title 12-18 字、要有钩子、通透、吸引 25-55 岁宝妈，写与她们息息相关的事（搞钱/底气/带娃闯关成长/不被生活拖垮）。
...
11. 【重要事实前提】这位宝妈目前【还没有通过自媒体赚到一分钱】，但她【赚钱的欲望非常强烈】，正在学习、搭建、坚持。因此文案中【严禁编造「已赚到广告费 / 已有稳定收入 / 账户余额变多 / 挣了X元」等虚假收入事实】；可以写【想赚、要搞钱、在学、在坚持、离目标更近、还没赚到但一定要赚到】的真实状态与强烈渴望。严禁出现『卡里有钱 / 兜里有钱 / 卡里余额 / 你挣的每一分钱』这类『现在就拥有财富』的表述，一律改为「想填满的卡 / 心里的底气 / 在搞钱 / 还没赚到第一笔」的渴望向表述；注意：可写想赚、在靠近，但不要 10 条都写「还没赚到钱」，要换着说法、每篇角度不同。
12. 图片文案（排版与说话感觉）要求（重要，作为每日稳定产出）：image_copywriting 的 10 条里，至少 3 条、目标 4-5 条必须采用「标题（钩子）+ 原句/金句（quote）+ 宝妈感悟（reflection）合并成图上正文」的爆款排版与语气（参考来源库「有效仿写」标杆样本：扎心年龄排比、跟谁混对比、通透感悟、赚钱底气——这些都是「说话的感觉」，不是固定题材，也不要每天用同一句原话二创）。关键点：① 题材来源——每日 10 条【严格按下列条数分配，合计正好 10 条，缺一不可】，题材面向 25-55 岁女性兴趣（情感、婚姻、家庭、搞钱、女性成长、育儿、怀旧金曲、明星话题、自我和解等），不局限于固定账号或某个人物，每天题材都要新鲜：
   · 【宝妈情感共鸣】必须正好 4 条：这 4 条的 quote 必须从下方「宝妈情感共鸣」素材库里直接摘抄真实原句（可从这些里挑：『淋过雨的人才知道一把伞有多重要』『家里收拾再干净饭做得再好吃也不如自己挣两千块来得有尊严有底气』『做自媒体就像跑一场马拉松拼的不是爆发力而是耐力』『我想挣很多的钱买下我的自卑买下我的欲望买下我的未来』『没有天生的强者只有坚持不懈的宝妈』『命运把我埋了没想到我是一颗种子』『人所有的翻盘都不靠运气靠的是别人放弃时你还在咬牙坚持』『等娃睡了夜晚偷偷成长没人支持没人鼓励依然咬牙坚持做自媒体』『为什么越来越多全职妈妈选择做自媒体不是她们闲是真的没有退路』），hot_source 标注『宝妈情感共鸣·<原句出处>』；这 4 条不要去碰抖音热搜；
   · 【抖音热搜】必须正好 2 条：从当日抖音热搜具体事件里找，偏搞钱/自我成长/宝妈生活，原句直接挂钩当日热搜事件；
   · 【人民日报/通透/扎心金句】必须正好 3 条：从金句库 / 通透句库 / 人名日报 / 扎心金句里挑，落到搞钱底气、女性成长、不当逃兵；
   · 【明星发言/热门歌曲】必须正好 1 条：按当日抖音热度选明星发言或热门歌曲歌词；
   每天题材新鲜不重复，禁止连续多天重复同一句原句。② quote 必须直接引用真实来源的原句（书摘/明星发言/金句/热搜原句/歌词/宝妈情感共鸣素材），并在 hot_source 标对应类别；quote 里禁止出现「还没赚到钱/想赚钱/在坚持」这类 AI 自己编的感慨（那是 reflection 该写的），必须是能被引用、有出处的原句；其中 4-5 条的 quote 必须直接引用「宝妈情感共鸣」素材库里的真实原句（带娃搞钱、自我成长、不内耗、不当逃兵等），hot_source 标注为「宝妈情感共鸣·<原句出处>」，可整句引用较长原句（长句拆成多行，整句金句可到 21-22 字），不必硬压到 12-16 字；禁止连续多天重复同一句原句；③ reflection 用「阿圆话术」语气（通透、不卖惨、不内耗、大气、利他）；【硬规则，必须执行】全 10 条 reflection 合计：『自媒体』三字最多出现 2 次，『还没赚到钱』最多出现 2 次，超过的务必用「流量/内容/记录/表达/被看见/深耕/慢慢变好/悄悄努力/向前走」等替代；只有约 2 条可明确写「做自媒体/做号/更新内容」并一笔带过给方向，其余 8 条一律不出现「自媒体」三字；每条 reflection 的角度和措辞都要不同，严禁 10 条反复出现「带娃做自媒体」「还没赚到钱」这类一模一样的句子，要换着说法（想搞钱/在靠近目标/心里有底气/正在扎根/不慌/向前走/活成自己的光/悄悄努力/把日子过好…）。④ img_text 严格按「标题+原句+感悟」合并成每句 12-16 字连贯正文（个别整句金句可到 21-22 字），并给出放图位置提示（图片上半部留白、衣服处，只放这一块）；⑤ body_long 必须 10 句、body_short 必须 5-6 句；⑥ 结尾带话题标签（参考「话题标签」，含 #宝妈勇闯自媒体 等）。其余条目也尽量沿用此基调。
"""
...
def cn_sents(s):
    """按中文句末标点或换行切句（保留标点），返回非空句子列表。
    同时兼容 AI 用 \n 分行写短句的情况（如 body_long 的 10 行诗），避免多句被并成一句。"""
    parts = re.split(r"(?<=[。！？!?\n])", s or "")
...
def main():
    ...
    # ---- 硬性约束：限制『还没赚到钱』出现次数，保证不重复、不卖惨 ----
    _ZQ_ALTS = ["还没变现", "离目标更近了", "正在悄悄扎根", "心里有光还没到账",
                "还没拿到第一笔", "正在靠近想要的生活", "正在一点点变好"]
    def _cap_zq(items, field, max_total):
        used = 0
        k = 0
        for x in items:
            t = x.get(field, "")
            cnt = t.count("还没赚到钱")
            if used + cnt <= max_total:
                used += cnt
                continue
            need = used + cnt - max_total
            parts = t.split("还没赚到钱")
            out = parts[0]
            for idx in range(1, len(parts)):
                if need > 0:
                    out += _ZQ_ALTS[k % len(_ZQ_ALTS)]; k += 1; need -= 1
                else:
                    out += "还没赚到钱"
                out += parts[idx]
            x[field] = out
            used = max_total
        return items
    img = _cap_zq(img, "reflection", 2)
    img = _cap_zq(img, "body_long", 3)
    img = _cap_zq(img, "body_short", 3)
